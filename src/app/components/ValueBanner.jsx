		...
		<section className="relative w-full h-[80vh] flex items-center">
			...
			<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
				<div className="w-full max-w-[32rem]">
					<h2 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-[2.9rem] font-extrabold leading-relaxed  font-poppins text-left">
						{t('valueBanner.title_line')}
					</h2>
					<p className="mt-5 text-white font-poppins font-light text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-left">
